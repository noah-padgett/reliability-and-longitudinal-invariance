...
wide.analysis.data <- wide.analysis.data %>%
  mutate(
...
ggplot(wide.analysis.data, aes(x=C1, y=C2))+
  geom_jitter()+
  theme_classic()
ggplot(wide.analysis.data, aes(x=S1, y=S2))+
  geom_jitter()+
  theme_classic()
ggplot(wide.analysis.data, aes(x=D1, y=D2))+
  geom_jitter()+
  theme_classic()

cor(wide.analysis.data[,c("C1","C2","S1","S2","D1","D2")])
# est: .65, .67, .66
```
